...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::any('/passenger', 'PassengersController@collectInformation')->name('passengerDetail');
    Route::any('/passenger/store', 'PassengersController@storeInformation')->name('passengerAdd');
...
Route::group(['namespace' => 'Backend', 'prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'schedules'], function () {
        ...
        Route::any('/seat', 'SchedulesController@viewSeatInfo')->name('viewSeatInfo');
